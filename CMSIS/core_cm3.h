 ...
 * Return the actual process stack pointer
 */
extern __ATTRIBUTES unsigned long __get_PSP(void);
 ...
 * (process stack pointer) Cortex processor register
 */
extern __ATTRIBUTES void __set_PSP(unsigned long topOfProcStack);
 ...
 * Cortex processor register
 */
extern __ATTRIBUTES unsigned long __get_MSP(void);
 ...
 * (main stack pointer) Cortex processor register
 */
extern __ATTRIBUTES void __set_MSP(unsigned long topOfMainStack);
 ...
 * Reverse byte order in unsigned short value
 */
extern __ATTRIBUTES unsigned long __REV16(unsigned long value);
 ...
 */
extern __ATTRIBUTES unsigned long __RBIT(unsigned long value);
 ...
 */
extern unsigned char __LDREXB(unsigned char const volatile *addr);
 ...
 * Exclusive LDR command
 */
extern unsigned short __LDREXH(unsigned short const volatile *addr);
 ...
 */
extern __ATTRIBUTES unsigned long __STREXB(unsigned char value, unsigned char volatile *addr);
 ...
 * Exclusive STR command
 */
extern __ATTRIBUTES unsigned long __STREXH(unsigned short value, unsigned short volatile *addr);
